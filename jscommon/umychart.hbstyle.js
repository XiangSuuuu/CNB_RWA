...
var BLACK_STYLE=
{
    ...
    //K线颜色
    UpBarColor: "rgb(0,186,164)",   //上涨
    DownBarColor: "rgb(211,77,104)",  //下跌
    ...
    UpTextColor: "rgb(7,172,144)",
    DownTextColor: "rgb(211,77,104)",
    UnchagneTextColor: "rgb(101,104,112)",
    CloseLineColor: 'rgb(113,121,133)',
    CloseLineAreaColor:['rgba(36,41,57,0.8)','rgba(22,34,53,0.3)'],
    FrameBorderPen: "rgba(236,236,236,0.13)",     //边框
    FrameSplitPen: "rgba(236,236,236,0.13)",          //分割线
    FrameSplitTextColor: "rgb(101,117,138)",     //刻度文字颜色
    FrameSplitTextFont: 12*GetDevicePixelRatio() +"px 微软雅黑",        //坐标刻度文字字体
    FrameTitleBGColor: "rgb(16,28,45)",      //标题栏背景色
